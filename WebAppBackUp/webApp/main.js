...
function openCart() {
  ...
  if (attribute === 'layer') {
    ...
    document.body.setAttribute('class', 'shadower');
    mainHeader.style.opacity = 0;
    //close when the user clicks anywhere in the window
    window.onClick = function(){
      cartOverLay.removeAttribute('id', 'layer');
    }
    // document.body.addEventListener('click', () => openCart())
  } else {
    cartOverLay.setAttribute('id', 'layer');
    document.body.removeAttribute('class', 'shadower');
